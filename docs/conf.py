...
project = 'MSL-Network'
copyright = network.__copyright__[1:]
author = network.__author__
...
version = network.__version__
# The full version, including alpha/beta/rc tags.
release = network.__version__
...
htmlhelp_basename = 'MSL-Networkdoc'
...
latex_documents = [
    (master_doc, 'MSL-Network.tex', 'MSL-Network Documentation',
...
man_pages = [
    (master_doc, 'MSL-Network', 'MSL-Network Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MSL-Network', 'MSL-Network Documentation',
     author, 'MSL-Network', 'MSL-Network',
     'Miscellaneous'),
]
